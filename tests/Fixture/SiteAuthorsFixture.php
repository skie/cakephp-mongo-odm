...
class SiteAuthorsFixture extends TestFixture
{
    ...
    public array $records = [
        ['_id' => '000000000000000000000001', 'name' => 'mark', 'site_id' => 1],
        ['_id' => '000000000000000000000002', 'name' => 'juan', 'site_id' => 2],
        ['_id' => '000000000000000000000003', 'name' => 'jose', 'site_id' => 2],
        ['_id' => '000000000000000000000004', 'name' => 'andy', 'site_id' => 1],
    ];
}

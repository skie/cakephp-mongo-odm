...
class SelectQueryTest extends TestCase
{
    ...
    /**
     * Test first() returns the first document.
     *
     * @return void
     */
    public function testFirst(): void
    {
        $collection = $this->connection->getCollection('select_first_test');
        $collection->deleteMany([]);
        $collection->insertMany([
            ['title' => 'A'],
            ['title' => 'B'],
        ...
        $query = new SelectQuery($this->connection, 'select_first_test');
        $query->orderBy(['title' => 'asc']);

        $this->assertSame('A', $query->first()['title']);
        $collection->deleteMany([]);
    }

    /**
     * Test first() returns null for an empty result.
     *
     * @return void
     */
    public function testFirstEmpty(): void
    {
        $query = new SelectQuery($this->connection, 'select_first_empty_test');
    ...
    {
        $collection = $this->connection->getCollection('select_count_test');
        $collection->deleteMany([]);
        $collection->insertMany([
            ['author_id' => 1],
            ['author_id' => 1],
        ...
        $query = new SelectQuery($this->connection, 'select_count_test');
        $query->where(['author_id' => 1]);
    ...
    /**
     * Test count() without a connection returns 0.
     *
     * @return void
     */
    public function testCountNoConnection(): void
    {

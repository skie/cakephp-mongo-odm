...
class PersistenceFailedException extends CakeException
{
     ...
     * @inheritDoc
     */
    protected string $messageTemplate = 'Document %s failure.';

    /**
     * Constructor.
     *
     * @param \Cake\Datasource\EntityInterface $entity The document on which the persistence operation failed.
    ...
    public function __construct(
        ...
        if (is_array($message)) {
            ...
            if ($errors) {
                ...
                $this->messageTemplate = 'Document %s failure. Found the following errors (%s).';
            }
        }

...
class SeedStatusCommand extends Command
{
    ...
    {
        return 'Show seed execution status.';
    }
    ...
    {
        return 'mongo migrations seed_status';
    }
    ...
    protected function buildOptionParser(ConsoleOptionParser $parser): ConsoleOptionParser
    {
        $parser->setDescription([
            ...
            '',
            '<info>mongo migrations seed_status</info>',
            '<info>mongo migrations seed_status --plugin Demo</info>',
            '<info>mongo migrations seed_status -f json</info>',
        ])->addOption('plugin', [
            'short' => 'p',
